  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\API\\v2\\DashboardController@getUsersList',
        'controller' => 'App\\Http\\Controllers\\API\\v2\\DashboardController@getUsersList',
        'namespace' => NULL,
        'prefix' => 'api/v1/user',
        'where' => 
        array (
